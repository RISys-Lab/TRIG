...
OUTPUT_DIR = "/home/muzammal/Projects/TRIG/data/output/tr_ml/imagen4"
MODEL_NAME = "imagen-4.0-generate-001"


def parse_args():
    parser = argparse.ArgumentParser(description="Batch generate images using Imagen 4")
...
def main():
    ...
    for item in tqdm(iter_range(data_list, args.start_idx, args.end_idx), desc="Generating images"):
        ...
        if render_text:
            final_prompt = final_prompt + " Include the text " + render_text + "."
        # 生成图片
