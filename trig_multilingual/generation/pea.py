...
parser.add_argument('--split', type=str, default=CONTENT_GENERATION_SPLIT)
parser.add_argument('--data_file', type=str, default=None, help='Optional legacy JSON file. Overrides dataset_name when set')
parser.add_argument('--output_dir', type=str, default="/leonardo_work/EUHPC_R04_192/fmohamma/TRIG/data/output/t2i_ml/PEA")
...
def generate_dataset(out_dir: str):
    ...
    data_list = load_content_generation_data(args.dataset_name, args.split, args.data_file)
