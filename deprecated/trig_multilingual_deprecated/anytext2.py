...
def process_json_data(json_path, base_mask_path="/data/dataset_zoo/TRIGv1.5/coarse_mask", 
    ...
    for item in data:
        ...
        prompt = item['prompt']
        text_prompt = item['dimension_prompt'][0]
        img_id = item['img_id']
        language_code = item['dimensions'][1]  # dimensions[1] is the language code
...
def main():
    ...
    for i, item_data in enumerate(process_json_data(args.json_path)):
